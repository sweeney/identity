...
# the active one. Restarts the identity service after upload.
...
#
# The config service has its own repo and deploy script at
# github.com/sweeney/config/deploy/deploy.sh.
#
set -euo pipefail
